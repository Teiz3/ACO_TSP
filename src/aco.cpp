...
int main() {
    // ProblemInstance a280 = load_tsplib_instance("problems/a280.tsp");// AS
    ProblemInstance att48 = load_tsplib_instance("problems/att48.tsp");// AS
    // ProblemInstance berlin52 = load_tsplib_instance("problems/berlin52.tsp");// AS
    // ProblemInstance bier127 = load_tsplib_instance("problems/bier127.tsp");// AS
    // ProblemInstance ch130 = load_tsplib_instance("problems/ch130.tsp");// AS
    // ProblemInstance ch150 = load_tsplib_instance("problems/ch150.tsp");// AS
    ProblemInstance eil51 = load_tsplib_instance("problems/eil51.tsp");// AS
    ProblemInstance eil76 = load_tsplib_instance("problems/eil76.tsp");// AS
    // ProblemInstance eil101 = load_tsplib_instance("problems/eil101.tsp");// AS
    // ProblemInstance fri26 = load_tsplib_instance("problems/fri26.tsp");// SEGMENTATION FAULT REDO LATER
    ...
    ProblemInstance pr76 = load_tsplib_instance("problems/pr76.tsp");// AS
    ...
    ProblemInstance st70 = load_tsplib_instance("problems/st70.tsp");// AS
    // ProblemInstance tsp225 = load_tsplib_instance("problems/tsp225.tsp");//

    ProblemInstance problem = att48;
